...
if(version=="h2geoboth"):
	...
	if(plot=="datatraj"):	
		...
		ax3.plot(timearr,sptemerr,label="sym/par T")
		ax3.plot(timearr,sltemerr,label="sym/lie T")
		ax3.plot(timearr,lptemerr,label="lie/par T")
		ax3.semilogy()
		ax3.legend(loc='upper left')	

		ax4.plot(timearr,spremerr,label="sym/par R")
		ax4.plot(timearr,slremerr,label="sym/lie R")
		ax4.plot(timearr,lpremerr,label="lie/par R")
		ax4.set_yscale("log")	
