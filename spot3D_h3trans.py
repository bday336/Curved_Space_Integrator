from symint_bank import symh3sptrans,imph3sptrans
...
testm.append(symh3sptrans(pos1i, pos1guess, pos2i, pos2guess, abgdot1i, abgdot1guess, abgdot2i, abgdot2guess, delT, massvec, sprcon, eqdist))
testp.append(imph3sptrans(abg1, abg1, abg2, abg2, abgdot1i, abgdot1guess, abgdot2i, abgdot2guess, delT, massvec, sprcon, eqdist))
...
while(q < nump-1):
	...
	testm.append(symh3sptrans(nextpos1m, nextpos1m, nextpos2m, nextpos2m, nextdot1m, nextdot1m, nextdot2m, nextdot2m, delT, massvec, sprcon, eqdist))
	testp.append(imph3sptrans(nextpos1p, nextpos1p, nextpos2p, nextpos2p, nextdot1p, nextdot1p, nextdot2p, nextdot2p, delT, massvec, sprcon, eqdist))
