...
step_data=[
	imph3sprotdis_mesh(mesh_copy, velocities_copy, delT, masses, sparr, damp_co, conn_list)
	]
...
while(q < nump-1):
    ...
    step_data=array([
        imph3sprotdis_mesh(new_mesh, new_velocities, delT, masses, sparr, damp_co, conn_list)
        ])
