...
for c in timearr:
	...
	checkhdata.append(hyper2poin2d(unformatvec2d(rotz2d(abri[1]) @ boostx2d(abri[0]) @ rotz2d(-abri[1]) @ rotz2d(arctan2(abdotti[1], abdotti[0])) @ formatvec2d(geodesicflow_x(c,liemag[0]) @ array([0.,0.,1.])))))
	checkemdata.append(unformatvec2d(rotz2d(abri[1]) @ boostx2d(abri[0]) @ rotz2d(-abri[1]) @ rotz2d(arctan2(abdotti[1], abdotti[0])) @ formatvec2d(geodesicflow_x(c,liemag[0]) @ array([0.,0.,1.]))))

	#checkhdata.append(hyper2poin2d(unformatvec2d(rotz2d(abri[1]) @ boostx2d(abri[0]) @ rotz2d(-abri[1]) @ rotz2d(arctan2(abdotti[1], abdotti[0])) @ formatvec2d(array([sinh(liemag[0]*c), cosh(liemag[0]*c)*sinh(0.), cosh(liemag[0]*c)*cosh(0.)])))))
	#checkemdata.append(unformatvec2d(rotz2d(abri[1]) @ boostx2d(abri[0]) @ rotz2d(-abri[1]) @ rotz2d(arctan2(abdotti[1], abdotti[0])) @ formatvec2d(array([sinh(liemag[0]*c), cosh(liemag[0]*c)*sinh(0.), cosh(liemag[0]*c)*cosh(0.)]))))
