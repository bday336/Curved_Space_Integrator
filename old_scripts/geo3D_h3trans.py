from symint_bank import symh3geotrans,imph3geotrans
...
gb=append(gb, abgt[1])
gg=append(gg, abgt[2])
testm.append(symh3geotrans(posi, posguess, abgdotti, abgdotguess, delT))
testp.append(imph3geotrans(abgt, abgt, abgdotti, abgdotguess, delT))		
