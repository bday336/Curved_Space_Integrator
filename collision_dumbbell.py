...
# Collision detection check (take radius of masses to be .2)
for dcheckin in dist[sp_num:2*sp_num]:
    if dcheckin<=.2+.2:
        print("collision detected")
        spcolidx=dist[sp_num:2*sp_num].index(dcheckin)
        new_velocities[mesh[1][spcolidx][0]], new_velocities[mesh[1][spcolidx][0]] = collisionh3(new_mesh[0][mesh[1][spcolidx][0]], new_mesh[0][mesh[1][spcolidx][1]], new_velocities[mesh[1][spcolidx][0]], new_velocities[mesh[1][spcolidx][0]], masses[mesh[1][spcolidx][0]], masses[mesh[1][spcolidx][1]], dcheckin)
