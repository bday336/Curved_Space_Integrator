...
#     [.5,np.pi/2.,2.*2.*np.pi/3.,0.,-.5,.0,1.,.2]         #particle 2
#     ])

# # Face on triangle (normalize the initial velocity in minkowski metric to have .5 as magnitude)
particles=array([
    ...
    [.5,np.pi/2.,2.*2.*np.pi/3.,-(.5*tanh(.5)/tan(2.*2.*np.pi/3.))/sqrt(tanh(.5)*tanh(.5)/tan(2.*2.*np.pi/3.)/tan(2.*2.*np.pi/3.)+sinh(.5)*sinh(.5)),0.,(.5)/sqrt(tanh(.5)*tanh(.5)/tan(2.*2.*np.pi/3.)/tan(2.*2.*np.pi/3.)+sinh(.5)*sinh(.5)),1.,.2]         #particle 2
    ])
